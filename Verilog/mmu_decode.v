...
`endif
  ...
  output cfcs_n;		// CF card chip select
...
`endif
  ...
  // Change to user mode when a kernel memory
...
`endif
  ...
  assign cfcs_n=       (kernio && i_addr[7:5] == 3'b001) ? 1'b0 : 1'b1;
  assign rtccs_n=      (kernio && i_addr[7:5] == 3'b010) ? 1'b0 : 1'b1;
